...
public class SwapCommandSMTTest {
    ...
    @Test
    public void swapNoArgsTest() throws ParserException, InvalidRuleApplicationException {
        String t1 = "f(1 + 1)";
        String t2 = "f(z)";
        String c1 = "[z ==i x + 0]";
    ...
    public void swapInvalidIndexTest() throws ParserException, InvalidRuleApplicationException {
        String t1 = "f(1 + 1)";
        String t2 = "f(z)";
        String c1 = "[z ==i x + 0]";
        Term l = LcTrsInputReader.readTermFromString(t1, lcTrs);
